...
public class SAMLSSOConfigService extends AbstractAdmin {
     ...
     * @throws IdentityException
     */
    public SAMLSSOServiceProviderDO addMetadataServiceProvider(String fileContent) throws IdentityException {
     ...
     * @throws IdentityException
     */
    public boolean isMetadataFileAdded(String fileContent) throws IdentityException {
        SAMLSSOMetadataConfigManager metadataConfigManager = new SAMLSSOMetadataConfigManager(getConfigUserRegistry());
        return metadataConfigManager.addMetadataSAMLSSOFileResource(fileContent,"testissuer");
    }
