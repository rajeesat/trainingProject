                ...
                if (localAssertionConsumerUrlTracker){
                             ...
                             if (localRequestedRecipients!=null) {
                                   ...
                                   for (int i = 0;i < localRequestedRecipients.length;i++){
                                         ...
                                         // write the null attribute
                                        // write null attribute
                                           writeStartElement(null, "http://dto.saml.sso.identity.carbon.wso2.org/xsd", "requestedRecipients", xmlWriter);
                  ...
                  if (fullTypeName!=null){
                    ...
                    java.lang.String type = fullTypeName.substring(fullTypeName.indexOf(":")+1);
                            ...
                            if (!"SAMLSSOServiceProviderDTO".equals(type)){
                                ...
                                return (SAMLSSOServiceProviderDTO)org.wso2.carbon.identity.sso.saml.stub.types.axis2.ExtensionMapper.getTypeObject(
                                     nsUri,type,reader);
                              }
                ...
                java.util.Vector handledAttributes = new java.util.Vector();
                    ...
                    reader.next();
                        ...
                        java.util.ArrayList list18 = new java.util.ArrayList();
                                    ...
                                    if (reader.isStartElement() && new javax.xml.namespace.QName("http://dto.saml.sso.identity.carbon.wso2.org/xsd","doEnableEncryptedAssertion").equals(reader.getName())){
                                    ...
                                    if (reader.isStartElement() && new javax.xml.namespace.QName("http://dto.saml.sso.identity.carbon.wso2.org/xsd","doValidateSignatureInRequests").equals(reader.getName())){
                                    ...
                                    if (reader.isStartElement() && new javax.xml.namespace.QName("http://dto.saml.sso.identity.carbon.wso2.org/xsd","enableAttributesByDefault").equals(reader.getName())){
                                    ...
                                    if (reader.isStartElement() && new javax.xml.namespace.QName("http://dto.saml.sso.identity.carbon.wso2.org/xsd","idPInitSSOEnabled").equals(reader.getName())){
                                    ...
                                    if (reader.isStartElement() && new javax.xml.namespace.QName("http://dto.saml.sso.identity.carbon.wso2.org/xsd","requestedRecipients").equals(reader.getName())){
                                    ...
                                    // Process the array and step past its final element's end.
                                            ...
                                            while(!loopDone18){
                                                ...
                                                if (reader.isEndElement()){
                                                    ...
                                                    if (new javax.xml.namespace.QName("http://dto.saml.sso.identity.carbon.wso2.org/xsd","requestedRecipients").equals(reader.getName())){
