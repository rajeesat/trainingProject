 ...
 */
            ...
            /**
            *  SingleLogoutRequestDTO bean class
            */
                  ...
                  if (serializeType){
                   ...
                   if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)){
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           namespacePrefix+":SingleLogoutRequestDTO",
                           xmlWriter);
                   } else {
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           "SingleLogoutRequestDTO",
                           xmlWriter);
                   }
    ...
    public static class Factory{
        ...
        */
        public static SingleLogoutRequestDTO parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception{
            SingleLogoutRequestDTO object =
                new SingleLogoutRequestDTO();
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance","type")!=null){
                  ...
                  if (fullTypeName!=null){
                    ...
                    java.lang.String type = fullTypeName.substring(fullTypeName.indexOf(":")+1);
                            ...
                            if (!"SingleLogoutRequestDTO".equals(type)){
                                //find namespace for the prefix
                                java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
                                return (SingleLogoutRequestDTO)org.wso2.carbon.identity.sso.saml.stub.types.axis2.ExtensionMapper.getTypeObject(
                                     nsUri,type,reader);
                              }
