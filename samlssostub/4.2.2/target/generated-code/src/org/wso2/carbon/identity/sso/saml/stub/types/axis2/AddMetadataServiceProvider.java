...
/**
 * AddMetadataServiceProvider.java
 *
 ...
 */
            ...
            /**
            *  AddMetadataServiceProvider bean class
            */
            @SuppressWarnings({"unchecked","unused"})
        
        public  class AddMetadataServiceProvider
                  ...
                  if (serializeType){
                   ...
                   if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)){
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           namespacePrefix+":addMetadataServiceProvider",
                           xmlWriter);
                   } else {
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           "addMetadataServiceProvider",
    ...
    public static class Factory{
        ...
        */
        public static AddMetadataServiceProvider parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception{
            AddMetadataServiceProvider object =
                new AddMetadataServiceProvider();
            ...
            try {
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance","type")!=null){
                  ...
                  if (fullTypeName!=null){
                    ...
                    java.lang.String type = fullTypeName.substring(fullTypeName.indexOf(":")+1);
                            ...
                            if (!"addMetadataServiceProvider".equals(type)){
                                //find namespace for the prefix
                                java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
                                return (AddMetadataServiceProvider)org.wso2.carbon.identity.sso.saml.stub.types.axis2.ExtensionMapper.getTypeObject(
                                     nsUri,type,reader);
                              }
                ...
                java.util.Vector handledAttributes = new java.util.Vector();
                    ...
                    reader.next();
                                    ...
                                    if (reader.isStartElement() && new javax.xml.namespace.QName("http://org.apache.axis2/xsd","fileContent").equals(reader.getName())){
