 ...
 */
            ...
            /**
            *  DoSingleLogout bean class
            */
            @SuppressWarnings({"unchecked","unused"})
        
        public  class DoSingleLogout
                  ...
                  if (serializeType){
                   ...
                   if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)){
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           namespacePrefix+":doSingleLogout",
                           xmlWriter);
                   } else {
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           "doSingleLogout",
    ...
    public static class Factory{
        ...
        */
        public static DoSingleLogout parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception{
            DoSingleLogout object =
                new DoSingleLogout();
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance","type")!=null){
                  ...
                  if (fullTypeName!=null){
                    ...
                    java.lang.String type = fullTypeName.substring(fullTypeName.indexOf(":")+1);
                            ...
                            if (!"doSingleLogout".equals(type)){
                                //find namespace for the prefix
                                java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
                                return (DoSingleLogout)org.wso2.carbon.identity.sso.saml.stub.types.axis2.ExtensionMapper.getTypeObject(
                                     nsUri,type,reader);
                              }
