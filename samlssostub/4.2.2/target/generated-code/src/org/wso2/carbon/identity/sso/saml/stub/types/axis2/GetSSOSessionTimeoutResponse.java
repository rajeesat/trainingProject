...
/**
 * GetSSOSessionTimeoutResponse.java
 *
 ...
 */
            ...
            /**
            *  GetSSOSessionTimeoutResponse bean class
            */
            @SuppressWarnings({"unchecked","unused"})
        
        public  class GetSSOSessionTimeoutResponse
        implements org.apache.axis2.databinding.ADBBean{
        
                public static final javax.xml.namespace.QName MY_QNAME = new javax.xml.namespace.QName(
                "http://org.apache.axis2/xsd",
                "getSSOSessionTimeoutResponse",
                "ns3");
                  ...
                  if (serializeType){
                   ...
                   if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)){
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           namespacePrefix+":getSSOSessionTimeoutResponse",
                           xmlWriter);
                   } else {
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           "getSSOSessionTimeoutResponse",
    ...
    public static class Factory{
        ...
        */
        public static GetSSOSessionTimeoutResponse parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception{
            GetSSOSessionTimeoutResponse object =
                new GetSSOSessionTimeoutResponse();
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance","type")!=null){
                  ...
                  if (fullTypeName!=null){
                    ...
                    java.lang.String type = fullTypeName.substring(fullTypeName.indexOf(":")+1);
                            ...
                            if (!"getSSOSessionTimeoutResponse".equals(type)){
                                //find namespace for the prefix
                                java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
                                return (GetSSOSessionTimeoutResponse)org.wso2.carbon.identity.sso.saml.stub.types.axis2.ExtensionMapper.getTypeObject(
                                     nsUri,type,reader);
                              }
