 ...
 */
            ...
            /**
            *  IsMetadataFileAdded bean class
            */
            @SuppressWarnings({"unchecked","unused"})
        
        public  class IsMetadataFileAdded
                  ...
                  if (serializeType){
                   ...
                   if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)){
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           namespacePrefix+":isMetadataFileAdded",
                           xmlWriter);
                   } else {
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           "isMetadataFileAdded",
    ...
    public static class Factory{
        ...
        */
        public static IsMetadataFileAdded parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception{
            IsMetadataFileAdded object =
                new IsMetadataFileAdded();
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance","type")!=null){
                  ...
                  if (fullTypeName!=null){
                    ...
                    java.lang.String type = fullTypeName.substring(fullTypeName.indexOf(":")+1);
                            ...
                            if (!"isMetadataFileAdded".equals(type)){
                                //find namespace for the prefix
                                java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
                                return (IsMetadataFileAdded)org.wso2.carbon.identity.sso.saml.stub.types.axis2.ExtensionMapper.getTypeObject(
                                     nsUri,type,reader);
                              }
