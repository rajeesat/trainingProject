...
/**
 * IsSAMLSSOLoginAcceptedResponse.java
 *
 ...
 */
            ...
            /**
            *  IsSAMLSSOLoginAcceptedResponse bean class
            */
            @SuppressWarnings({"unchecked","unused"})
        
        public  class IsSAMLSSOLoginAcceptedResponse
        implements org.apache.axis2.databinding.ADBBean{
        
                public static final javax.xml.namespace.QName MY_QNAME = new javax.xml.namespace.QName(
                "http://org.apache.axis2/xsd",
                "isSAMLSSOLoginAcceptedResponse",
                "ns3");
                  ...
                  if (serializeType){
                   ...
                   if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)){
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           namespacePrefix+":isSAMLSSOLoginAcceptedResponse",
                           xmlWriter);
                   } else {
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           "isSAMLSSOLoginAcceptedResponse",
    ...
    public static class Factory{
        ...
        */
        public static IsSAMLSSOLoginAcceptedResponse parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception{
            IsSAMLSSOLoginAcceptedResponse object =
                new IsSAMLSSOLoginAcceptedResponse();
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance","type")!=null){
                  ...
                  if (fullTypeName!=null){
                    ...
                    java.lang.String type = fullTypeName.substring(fullTypeName.indexOf(":")+1);
                            ...
                            if (!"isSAMLSSOLoginAcceptedResponse".equals(type)){
                                //find namespace for the prefix
                                java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
                                return (IsSAMLSSOLoginAcceptedResponse)org.wso2.carbon.identity.sso.saml.stub.types.axis2.ExtensionMapper.getTypeObject(
                                     nsUri,type,reader);
                              }
